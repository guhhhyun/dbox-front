...
console.debug("HistoryGrid.js");

const HistoryGrid = forwardRef(function ({ onGridReady, rowData, onNameDoubleClick, onNameClick, onNameClickAway, onSortClick, onFilterClick, height }, ref) {
  // 컬럼 기본값 정의
  const gridOptions = {
    headerHeight: 40,
    rowHeight: 36,
