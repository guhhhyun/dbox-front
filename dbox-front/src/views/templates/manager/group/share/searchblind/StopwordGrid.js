...
import styles from "./StopwordGrid.module.css";

console.debug("StopwordGrid.js");

const StopwordGrid = forwardRef(function ({ onGridReady, rowData, onNameDoubleClick, onNameClick, onNameClickAway, onSortClick, onFilterClick, height }, ref) {
  // 컬럼 기본값 정의
  const gridOptions = {
    headerHeight: 40,
    rowHeight: 36,
  ...
  return (
    ...
    >
      <div className="ag-theme-balham">
        <div className={styles.gridBox} style={{ height: 200 }}>
          <AgGridReact
            ref={ref}
            className={styles.height100per}
