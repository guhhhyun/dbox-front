...
console.debug("ManualLockModalButtonContainer.js");

export default function ManualLockModalButtonContainer({ checkedList, getData }) {
  const [opened, setOpened] = useState(false);
  const [openedAlert, setOpenedAlert] = useState(false);

  const buttonOption = {
    buttonName: "잠금",
    content: "총 " + checkedList.length + "명의 사용자를 잠금 처리 하시겠습니까?",
    okText: "예",
    cancelText: "아니오",
  };
