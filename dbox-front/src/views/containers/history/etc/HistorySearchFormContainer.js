...
import SearchHistoryFormAll from "views/templates/history/common/search/SearchHistoryFormAll";
import { alertDialog } from "locales/ko";

console.debug("HistorySearchFormContainer.js");

export default function HistorySearchFormContainer({ onSearchCompany, getSearchData, defaultStartData, defaultEndDate }) {
  ...
  const onSearch = async () => {
    ...
    if (valid) {
      try {
        ...
        getSearchData(companyCode, deptCode, userCode, startDate, endDate, searchSelect, searchText);
        /*
