...
import styles from "./ResearchPropertyModal.module.css";
import { AddCircle } from "@material-ui/icons";

console.debug("ResearchPropertyModal.js");
...
export default function ResearchPropertyModal({
  name,
  onNameChange,
  secLevel,
  onSecLevelChange,
      ...
      <Box className={styles.tabContents}>
        <TabPanel value={tab} index={0}>
          ...
          <Box className={classes.group}>
            ...
            <Typography>{chiefName}</Typography>
          ...
          <Box className={classes.group}>
            ...
            <Typography>{finishYn}</Typography>
          </Box>
          <Box>
