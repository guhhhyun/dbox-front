...
import SearchHistoryEtcAttachForm from "views/templates/history/common/search/SearchHistoryEtcAttachForm";

console.debug("HistorySearchAttachFormContainer.js");

export default function HistorySearchAttachFormContainer({ onSearchCompany, getSearchData, defaultStartData, defaultEndDate }) {
