...
import AttachGrid from "views/templates/manager/group/attach/AttachGrid";
import NodeApi from "apis/node-api";
import CommonUtil from "utils/common-util";

console.debug("AttachGridContainer.js");

const AttachGridContainer = forwardRef(function ({ height, gridKey }, ref) {
...
export default AttachGridContainer;
